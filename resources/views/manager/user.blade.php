...
<div class="row">
        ...
        <div class="col-md-12">
            @if (session('user-updated'))
                @component('manager.components.alert')
                    @slot('type')
                        success
                    @endslot
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="type" id="role">
                                <option value="admin" {{ old('type', $user->type) === 'admin' ? 'selected' : '' }}>@lang('Administrator')</option>
                                 <option value="user" {{ old('type', $user->type) === 'user' ? 'selected' : '' }}>@lang('User')</option>
                            </select>
                        </div>
                        @if ($user->ingoing)
                            <div class="checkbox">
